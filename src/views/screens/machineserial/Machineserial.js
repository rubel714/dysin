...
import MachineserialAddEditModal from "./MachineserialAddEditModal";

const Machineserial = (props) => {
...
{permissionType === 0 && (<DeleteOutline
  ...
  return (
    <>
      ...
      {showModal && (<MachineserialAddEditModal masterProps={props} currentRow={currentRow} modalCallback={modalCallback}/>)}
