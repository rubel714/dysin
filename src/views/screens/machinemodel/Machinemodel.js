...
import MachinemodelAddEditModal from "./MachinemodelAddEditModal";

const Machinemodel = (props) => {
...
{permissionType === 0 && (<DeleteOutline
  ...
  return (
    <>
      ...
      {showModal && (<MachinemodelAddEditModal masterProps={props} currentRow={currentRow} modalCallback={modalCallback}/>)}
