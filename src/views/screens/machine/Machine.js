...
import MachineAddEditModal from "./MachineAddEditModal";

const Machine = (props) => {
  const serverpage = "machine"; // this is .php server page
  ...
  return (
    <>
      <div class="bodyContainer">
        ...
        <div class="topHeader">
          <h4>
            <a href="#">Home</a> ❯ Machinery Setup ❯ Machine
          </h4>
        </div>
      ...
      {showModal && (<MachineAddEditModal masterProps={props} currentRow={currentRow} modalCallback={modalCallback} />)}
