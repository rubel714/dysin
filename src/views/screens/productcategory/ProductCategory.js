...
import ProductCategoryAddEditModal from "./ProductCategoryAddEditModal";
...
const ProductCategory = (props) => {
  ...
  return (
    <>
      ...
      {showModal && (<ProductCategoryAddEditModal masterProps={props} currentRow={currentRow} modalCallback={modalCallback} />)}
