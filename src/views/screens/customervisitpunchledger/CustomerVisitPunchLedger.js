...
const CustomerVisitPunchLedger = (props) => {
  ...
  const ExcelGenerate = () => {
    ...
    let finalUrl =
      EXCEL_EXPORT_URL + "report/CustomerVisitPunchLedger_excel.php";
    window.open(
      finalUrl +
      "?DepartmentId=" +
      currDepartmentId +
...
export default CustomerVisitPunchLedger;
