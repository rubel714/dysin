...
// a.TransactionId id,DATE_FORMAT(a.TransactionDate, '%d-%b-%Y %h:%i:%s %p') AS TransactionDate,
// 			a.UserId,b.UserName,d.CustomerCode,d.CustomerName,a.ContactPersonName,a.ContactPersonDesignation,
// 			 a.ContactPersonMobileNumber,a.SelfDiscussion,'' HOTAdvice
foreach ($sqlLoop1result as $result) {
    ...
    <td style="width:10% !important;" class="border_Remove">'.$result['UserName'].'</td> 
    <td style="width:20% !important;" class="border_Remove">'.$result['CustomerName'].'</td> 
    <td style="width:10% !important;" class="border_Remove">'. $result['ContactPersonName'].'</td>
    <td style="width:10% !important;" class="border_Remove">'.$result['ContactPersonDesignation'].'</td>
    <td style="width:25% !important;" class="border_Remove">'. $result['SelfDiscussion'].'</td>
    <td style="width:10% !important;" class="border_Remove">'. $result['HOTAdvice'].'</td>
    </tr>';
...
$pdf->setAuthor('DYSIN');
$pdf->setTitle('Visit Summary Report');
...
$tblHeader0 = '<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <h2 class="center-aln" style="font-size: 15px; ">Visit Summary Report</h2>
                    ...
                    <tbody >
                        <thead>
                            <tr class="ittaliy">
                                ...
                                <th rowspan="1" style="width:10% !important;">'. 'Visit Date'.'</th>
                                <th rowspan="1" style="width:10% !important;">'. 'Employee Name'.'</th>
                                <th rowspan="1" style="width:20% !important;">'. 'Customer Name'.'</th>
                                <th rowspan="1" style="width:10% !important;">'. 'Contact Name'.'</th>
                                <th rowspan="1" style="width:10% !important;">'. 'Designation'.'</th>
                                <th rowspan="1" style="width:25% !important;">'. 'Self Discussion'.'</th>
                                <th rowspan="1" style="width:10% !important;">'. 'HOT Advice'.'</th>
                            </tr>
                        </thead>
                        '.$dataList.'
