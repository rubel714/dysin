...
foreach ($sqlLoop1result as $result) {
    ...
    <td style="width:18% !important;" class="border_Remove">'.$result['TransactionDate'].'</td>
    <td style="width:10% !important;" class="center-aln border_Remove">'.$result['UserId'].'</td> 
    <td style="width:18% !important;" class="border_Remove">'. $result['UserName'].'</td>
    <td style="width:10% !important;" class="center-aln border_Remove">'.$result['CustomerCode'].'</td>
    <td style="width:17% !important;" class="border_Remove">'. $result['CustomerName'].'</td>
    <td style="width:9% !important;" class="center-aln border_Remove">'. $result['LinemanUserId'].'</td>
    <td style="width:13% !important;" class="border_Remove">'. $result['LinemanUserName'].'</td>
    </tr>';
}
...
$pdf->setAuthor('DYSIN');
$pdf->setTitle('Customer Visit Plan');
...
$tblHeader0 = '<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <h2 class="center-aln" style="font-size: 15px; ">Customer Visit Plan</h2>
                    ...
                    <tbody >
                        <thead>
                            <tr class="ittaliy">
                                ...
                                <th rowspan="1" style="width:18% !important;">Visit Plan Date</th>
                                <th rowspan="1" style="width:10% !important;" class="center-aln">Employee ID</th>
                                <th rowspan="1" style="width:18% !important;">Employee Name</th>
                                <th rowspan="1" style="width:10% !important;" class="center-aln">Customer Code</th>
                                <th rowspan="1" style="width:17% !important;">Customer Name</th>
                                <th rowspan="1" style="width:9% !important;" class="center-aln">Line Manager ID</th>
                                <th rowspan="1" style="width:13% !important;">Line Manager Name</th>
                            </tr>
                        </thead>
                        '.$dataList.'
...
$file = 'VisitPlan-' . $exportTime . '.pdf'; //Save file name
