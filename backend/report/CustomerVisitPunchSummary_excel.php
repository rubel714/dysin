...
$spreadsheet = new Spreadsheet();
    ...
    $reporttitlelist[] = "Customer Visit Punch Summary";
...
$spreadsheet->getActiveSheet()->getStyle('B'.$rn)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
$spreadsheet->getActiveSheet()->getStyle('C'.$rn)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT);
...
$file = 'CustomerVisitPunchSummary-' . $exportTime . '.xlsx'; //Save file name
