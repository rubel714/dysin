...
$pdf->setAuthor('DYSIN');
$pdf->setTitle('Machinery Installation Report');
...
$tblHeader0 = '<br/><br/><br/><!DOCTYPE html>
            <html>
                <head>
                    ...
                    <h2 class="right-aln" style="font-size: 15px; ">Machinery Installation Report</h2>
...
$file = 'MachineryInstallationReport-' . $exportTime . '.pdf'; //Save file name
